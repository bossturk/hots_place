...
const overlayLink = "https://raw.githubusercontent.com/CptDinosaur/hots_place/main/wow-hots.png";
...
function startNotify(){
    if(!START_NOTIFIED){
        Toastify({
            text: `Thanks for contributing to the Hots/Wow Logo Alliance! (click here to join our discord)`,
            duration: SECOND * 10,
            onClick: () => {
                window.location = "https://discord.gg/qm5bTCmF";
            }
        }).showToast();
